...
urlpatterns = [
    ...
    path('question/update/<int:post_id>/', views.update_question, name='update_question'),
    ...
    path('answer/update/<int:post_id>/<int:question_id>/', views.update_answer, name='update_answer'),
