...
urlpatterns = [
    ...
    path('search/<str:keyword>/<str:category>/<str:board_type>/<str:post_type>/<str:search_type>/', views.search_page, name='search_page'),
    path('search/<str:category>/<str:board_type>/<str:post_type>/<str:search_type>/', views.post_list_page, name='post_list_page'),
